...
class Commander {
  ...
  _registerHandler (cmdName, cmdHandler) {
    if (cmdHandler.handler &&
        cmdHandler.handler.constructor &&
        cmdHandler.handler.constructor.name === 'GeneratorFunction') {
  ...
  registerCommandHandler (commandKey, commandDesc, commandOptions,
    ...
    this._registerHandler (commandKey, command);
  }
